...
import java.net.URL;
public class DadosdiscotesteTest {
  ...
  @Test
  public void dadosdiscoteste() {
    driver.get("http://localhost:8081/BD/index.jsp");
    driver.manage().window().setSize(new Dimension(1536, 816));
    driver.findElement(By.cssSelector(".btn-basic")).click();
    driver.findElement(By.id("nota")).click();
    driver.findElement(By.id("nota")).sendKeys("10");
